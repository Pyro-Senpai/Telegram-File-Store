...
👉 <b><a href="https://t.me/AnimeSenpaiWorld">ᴄʟɪᴄᴋ ʜᴇʀᴇ ꜰᴏʀ ᴛᴜᴛᴏʀɪᴀʟ 🎬</a></b></blockquote>
<b>» ᴄᴏᴍᴍᴀɴᴅꜱ:</b>
    ...
    await client.send_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("• ᴏᴡɴᴇʀ", url="https://t.me/AnimeSenpaiWorld", style="success"),
                    InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ •", url="https://t.me/AnimeSenpaiWorld", style="success")
                ],
                [
                    InlineKeyboardButton("• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ •", url="https://t.me/AnimeSenpaiWorld", style="success")
                ],
            ]
        )
    )
